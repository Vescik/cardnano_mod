<template>
  <div class="container">
    <ActivityModal>
      <div v-if="activityModalStore.modalType === 'addUser'">
        <AddUserForm/>
      </div>
      <div v-else-if="activityModalStore.modalType ==='showUser'">
        <SingleMemberProfile/>
      </div>
      <div v-else-if="activityModalStore.modalType ==='addBenefit'">
        <AddBenefitForm/>
      </div>
    </ActivityModal>
    <NavbarMain/>
  <main class="panel__container">
        ...
        <div class="panel__box"> 
          <router-view/>
          <UserProfile  v-if="userStore.user.isLogged"
          :userName = "userName"
          :userTitle = "userTitle"
...
<script setup lang="ts">
  ...
  import AddBenefitForm from './components/AddBenefitForm.vue';
  import SingleMemberProfile from './components/SingleMemberProfile.vue';

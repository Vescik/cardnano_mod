    ...
    <div class="form_container">
       ...
       <div>
        <div class="group-inputs">
            ...
            <button @click="handleAddBenefit" >Dodaj</button>
        ...
        <div class="group-inputs">
            ...
            <ul class="benefit_container">
              <li @click="handleRemoveBenefit"  class="benefit_el" v-for="benef in benefits.benefitList" :key="benef">
              {{ benef }}
              </li>
            </ul>
...
const handleRemoveBenefit = (index: number) => {
  benefits.value.benefitList.splice(index, 1)
}
